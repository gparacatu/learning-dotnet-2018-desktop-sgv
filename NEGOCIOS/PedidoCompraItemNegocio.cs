...
namespace NEGOCIOS
{
    public class PedidoCompraItemNegocio
    {
        AcessoBancoSqlServer conexao = new AcessoBancoSqlServer();

        public string Inserir(PedidoCompraItem pedidoItem)
        {
            try
            {
                ...
                string IDPedido = conexao.ExecutarManipulacao(CommandType.StoredProcedure, "uspPedidoCompraItemInserir").ToString();
